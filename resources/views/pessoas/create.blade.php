            ...
            <div class="card-body">
                <form method="POST" action="{{ route('pessoas.store') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input id="email" type="mail" class="form-control @error('email') is-invalid @enderror" name="email" required autocomplete="email">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input id="telefone" type="tel" class="form-control @error('telefone') is-invalid @enderror" name="telefone" required autocomplete="telefone">
